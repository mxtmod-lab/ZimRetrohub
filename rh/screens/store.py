...
class StoreScreen(BaseScreen):
    ...
    def get_footer_actions(self):
        ...
        actions.append(("Y", tr("dlq_open"), (255, 200, 0), (220, 225, 235), True))
...
"""
    ...
    def handle_input(self, inputs):
        ...
        # Y: hang cho tai, mo duoc tu bat ky tang nao cua Store.
        if inputs.get("btn_y"):
    ...
    def render(self, engine):
        ...
        for i, item in enumerate(visible_items):
            ...
            if item.get("game_info"):
                ...
                if _dst == "cancelling":
                    badge_text = tr("dlq_status_cancelling")
                    badge_bg = (56, 16, 16)
                    badge_border = (255, 90, 90)
                    badge_fg = (255, 120, 120)
                elif _dst == "paused":
                    badge_text = tr("dlq_status_paused")
                    badge_bg = (56, 40, 12)
                    badge_border = (255, 170, 60)
                    badge_fg = (255, 190, 90)
                elif _dst == "downloading":
